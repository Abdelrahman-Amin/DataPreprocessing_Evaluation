...
X, y = make_classification(n_samples=NumberOfSamplesToBeGenerated, n_features=25, n_redundant=0, n_clusters_per_class=1, weights=[1], flip_y=0, random_state=1, shuffle=False, scale=0)
